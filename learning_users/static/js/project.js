var playerone=prompt('Enter player One name, You are red')
var player1color='rgb(244, 65, 65)'
var playertwo=prompt('Enter player Two name,You are Blue!')
...
$('.h3').text(playerone+", it is your turn, please pick a column to drop your red chip.")
...
$('.board button').on('click',function(){
  ...
  if (horizontalWinCheck() || verticalWinCheck() || diagonalWinCheck()) {
    $('.lead').text('Congratulations!,You won ' +currentName)
    $('.h3').fadeOut('fast');
    $('h2').fadeOut('fast');
  }
